...
<ul class="layui-nav layui-nav-tree left-menu0"  lay-filter="test">
    <li class="layui-nav-item ">
        <a class="" href="javascript:;"><i class="layui-icon"></i>菜单管理</cite></a>
        <dl class="layui-nav-child">
            <dd><a href="javascript:;" data-url="/menu/list" data-id="1"><i class="layui-icon">&#xe651;</i><cite>菜单列表</cite></a></dd>
...
<ul class="layui-nav layui-nav-tree left-menu1" lay-filter="test">
    ...
    <li class="layui-nav-item">
        ...
        <dl class="layui-nav-child">
            ...
            <dd>
                <a href="javascript:;" data-url="/database/index" data-id="41">数据库配置</a>
            </dd>
        </dl>
    </li>
    <li class="layui-nav-item">
...
<ul class="layui-nav layui-nav-tree left-menu3" lay-filter="test">
    <li class="layui-nav-item">
        ...
        <dl class="layui-nav-child">
            <dd>
                <a href="javascript:;" data-url="https://www.layui.com/doc/" data-id="41">登录日志</a>
            </dd>
            <dd>
                <a href="javascript:;" data-url="https://www.layui.com/doc/" data-id="42">操作日志</a>
            </dd>
        </dl>
    </li>
</ul>
<ul class="layui-nav layui-nav-tree left-menu4" lay-filter="test">
    <li class="layui-nav-item">
        ...
        <dl class="layui-nav-child">
            <dd>
                <a href="javascript:;" data-url="https://www.layui.com/doc/" data-id="43">登录日志</a>
            </dd>
            <dd>
                <a href="javascript:;" data-url="https://www.layui.com/doc/" data-id="44">操作日志</a>
            </dd>
        </dl>
    </li>
</ul>
<ul class="layui-nav layui-nav-tree left-menu6" lay-filter="test">
    <li class="layui-nav-item">
        ...
        <dl class="layui-nav-child">
            <dd>
                <a href="javascript:;" data-url="https://www.layui.com/doc/" data-id="45">登录日志</a>
            </dd>
            <dd>
                <a href="javascript:;" data-url="https://www.layui.com/doc/" data-id="46">操作日志</a>
            </dd>
        </dl>
    </li>
</ul>